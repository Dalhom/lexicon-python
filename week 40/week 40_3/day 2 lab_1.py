...
base = input('Enter a base number or 0 to end: ')

while int(base) != 0:
    exponent = input('Enter the exponential number: ')
    print('The calculation is ', int(base) ** int(exponent))

    base = input('Enter another base number or 0 to end: ')
